 ...
 * Generated at: 2019-09-16 18:54:14 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            <p>In 2006, H+ Sport founder <a href=\"#employees-henrytwill\">Henry Twill</a> set out to create supplements and nutritional products made from the <em>purest ingredients</em> and backed by scientific and <em>performance data</em> â to provide a strong basis of <em>trust and accountability</em>.</p>\r\n");
      ...
      out.write("            <p>Today that vision has become H+ Sportâ¦offering a variety of <a href=\"#products\">supplements, energy bars and rehydration solutions</a>. At the foundation of H+ Sports are products backed by scientific and performance data.</p>\r\n");
      out.write("        </div>\r\n");
      ...
      out.write("        <p>Weâre committed to creating products that <em>defy convention</em>, and inspire our customers with pride and trust. In fact, we guarantee <a href=\"#products\">every product</a> we sell. If youâre not 100 percent happy with your purchase, you can return it during the first 60 days, <em>no questions asked</em>.</p>\r\n");
      out.write("        <p>Philanthropy is extremely important to us. In fact, <em>each employee volunteers</em> for organization of his or her choice, on the clock, for two hours each week. We know that doing good, breeds more doing good, and weâre happy to <em>promote a cycle</em> of volunteerism that just keeps on giving.</p>\r\n");
      out.write("    </div>\r\n");
